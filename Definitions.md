...
----------------
- **Ковариантность (out)** - позволяет использовать более конкретный тип, чем заданный изначально: IBank <out T>
- **Контравариантность (in)** - позволяет использовать более универсальный тип, чем заданный изначально: ITransaction<in T>
